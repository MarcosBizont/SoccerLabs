$(function(){
 ...
 $.ajax({
		...
		success: function (response) {
			...
			var htmlContent = $('<div id="wrapSoccerLabsWidget" style="width: 300px; height:350px; overflow:auto; border: 1px solid #CCD0D3; font-family: Helvetica;">');
			...
			$(json).each(function(i,val){
				...
				'<span style="position: relative; top: -9px; font-weight: bold;">Apuesta gratis en </span>' +
					'<img src="logoSoccerLabs.png" style="width: 120px; height: 30px;" />' +
				'</div>' +
