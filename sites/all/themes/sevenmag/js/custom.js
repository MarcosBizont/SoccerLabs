jQuery(document).ready(function ($) {
	...
	setTimeout(function() {
        $(".page-node-4629 .inplayoutside .messages").hide('slow');
    }, 10000);
	...
	$('.node-type-match .thecontent, .node-type-team .thecontent ').parent().hide();
	
	$('#orinlogin a').click(function()
	{
		$('.precontentinhome #user-register-form').slideToggle();
	});
